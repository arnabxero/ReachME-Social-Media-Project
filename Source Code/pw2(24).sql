...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2022 at 02:13 PM
...
(10, '        qwdrtyuiuo', 'new req', 2, '11:27 AM|2022/05/18', '', 'arnabxero'),
(11, '        Restrict Nusrat AMy?', 'Profile Restriction', 2, '11:28 AM|2022/05/18', 'Yes, restrict', 'arnabxero'),
(12, '        erty', 'ertyu', 2, '03:23 PM|2022/05/18', 'ertyu', 'arnabxero');
...
('Nusrat', 'Amy', 'nusratamy', 'nusrat.amy@gmail.com', '01594332175', 'Student', 'Hello I am an SSC student.', 'nusrat', 9, 'Y', 0, 0, '9.jpg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Active', 'YES'),
...
-- Events
--
CREATE DEFINER=`root`@`localhost` EVENT `promote_post_167` ON SCHEDULE AT '2022-05-27 22:00:28' ON COMPLETION NOT PRESERVE ENABLE DO DELETE FROM `promoted` WHERE post_id = '167'$$
